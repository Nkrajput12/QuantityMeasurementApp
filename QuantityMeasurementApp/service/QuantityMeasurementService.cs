...
{   
    ...
    /// <summary>
    /// This Method Use to add two Quantity
    /// </summary>
    /// <param name="q1"> Quantity first</param>
    /// <param name="q2"Quantity second</param>
    /// <returns> return the Quantity of unit of q1 after adding q2</returns>
    public Quantity DemonstrateAddition(Quantity q1, Quantity q2)
    {
        return q1.Add(q2);
    }
