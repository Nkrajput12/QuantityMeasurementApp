...
namespace QuantityMeasurementApp.Models
{
        ...
        where TUnit : struct, Enum
    {
        ...
        private double PerformBaseArithmetic(Quantity<TUnit> other, ArithmeticOperation operation)
        {
            ...
            {
                throw new InvalidOperationException($"Temperature does not support {operation.ToString().ToLower()} operations.");
            }
            //Validation
        ...
        public Quantity<TUnit> ConvertTo(TUnit target)
        {
            ...
            else if (target is TemperatureUnit t) converted = TemperatureUnitExtension.ConvertFromBase(t, baseValue);
