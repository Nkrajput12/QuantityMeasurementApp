...
public class CentralizeArithmeticOprTest
{
    ...
    {
        var q1 = new Quantity<LengthUnit>(1.0, LengthUnit.Feet);   // 12 inches
        var q2 = new Quantity<LengthUnit>(6.0, LengthUnit.Inches); // 6 inches
    ...
    public void TestRefactoring_Subtract_DelegatesViaHelper()
    {
        ...
        var q1 = new Quantity<LengthUnit>(1.0, LengthUnit.Feet);   // 12 inches
        var q2 = new Quantity<LengthUnit>(2.0, LengthUnit.Inches); // 2 inches
    ...
    public void TestRefactoring_Divide_DelegatesViaHelper()
    {
        ...
        var q1 = new Quantity<LengthUnit>(1.0, LengthUnit.Feet);   // 12 inches
        var q2 = new Quantity<LengthUnit>(4.0, LengthUnit.Inches); // 4 inches
    ...
    public void TestArithmeticOperation_Add_EnumComputation()
    {
        ...
        var q1 = new Quantity<LengthUnit>(10, LengthUnit.Inches);
        var q2 = new Quantity<LengthUnit>(5, LengthUnit.Inches);
    ...
    {
        var q1 = new Quantity<LengthUnit>(10, LengthUnit.Inches);
        var q2 = new Quantity<LengthUnit>(0, LengthUnit.Inches);
    ...
    {
        var q1 = new Quantity<WeightUnit>(20, WeightUnit.Kilograms);
        var q2 = new Quantity<WeightUnit>(2, WeightUnit.Kilograms);
    ...
    public void TestAdd_UC12_BehaviorPreserved()
    {
        ...
        var litre = new Quantity<VolumeUnit>(3.78, VolumeUnit.Litre);
    ...
    public void TestSubtract_UC12_BehaviorPreserved()
    {
        ...
        var q1 = new Quantity<WeightUnit>(1.0, WeightUnit.Kilograms);
        var q2 = new Quantity<WeightUnit>(500, WeightUnit.Grams);
    ...
    public void TestRounding_Divide_NoRounding()
    {
        ...
        var q2 = new Quantity<LengthUnit>(3.0, LengthUnit.Inches);
