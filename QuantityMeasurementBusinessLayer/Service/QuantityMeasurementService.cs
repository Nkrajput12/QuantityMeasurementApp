...
namespace QuantityMeasurementBusinessLayer.Services
{
    public class QuantityMeasurementService : IQuantityMeasurementService
    {
        ...
        public QuantityDTO Convert<T>(QuantityDTO source, string targetUnit) where T : struct, Enum
        {
            ...
            dataRepo.SaveToDatabase(record);
        ...
        public IEnumerable<CacheRecordDto> GetHistory()
        {
            Console.WriteLine("Press 1 GetHistory from RAM");
            Console.WriteLine("Press 2 GetHistory from DataBase");
            ...
            switch (choice)
            {
                ...
                default:
                Console.WriteLine("Invalid Choice returning RAM history");
                return _cacheRepo.GetAllHistory();
            }
        }
    }
