...
namespace QuantityMeasurementApp.Tests
{
    ...
    public class VolumeMeasurementTests
    {
        ...
        {
            var q1 = new Quantity<VolumeUnit>(1.0, VolumeUnit.Litre, _volumeConverter);
            var q2 = new Quantity<VolumeUnit>(1.0, VolumeUnit.Litre, _volumeConverter);
        ...
        {
            // 1 Litre = 1000 ML
            var litre = new Quantity<VolumeUnit>(1.0, VolumeUnit.Litre, _volumeConverter);
            var ml = new Quantity<VolumeUnit>(1000.0, VolumeUnit.MilliLiter, _volumeConverter);
        ...
        public void testEquality_LitreToGallon_EquivalentValue_ShouldReturnTrue()
        {
            ...
            var litre = new Quantity<VolumeUnit>(3.78541, VolumeUnit.Litre, _volumeConverter);
        ...
        public void testAddition_LitreAndML_ShouldReturnSumInLitre()
        {
            // 1.0L + 1000mL = 2.0L
            var q1 = new Quantity<VolumeUnit>(1.0, VolumeUnit.Litre, _volumeConverter);
            var q2 = new Quantity<VolumeUnit>(1000.0, VolumeUnit.MilliLiter, _volumeConverter);
        ...
        public void testAddition_LitreAndGallon_ExplicitTarget_ShouldReturnSumInGallon()
        {
            ...
            var q1 = new Quantity<VolumeUnit>(3.78541, VolumeUnit.Litre, _volumeConverter);
            var q2 = new Quantity<VolumeUnit>(1.0, VolumeUnit.Gallon, _volumeConverter);
        ...
        {
            var volume = new Quantity<VolumeUnit>(1.0, VolumeUnit.Litre, _volumeConverter);
            var length = new Quantity<LengthUnit>(1.0, LengthUnit.Feet, _lengthConverter);
        ...
        {
            var zeroL = new Quantity<VolumeUnit>(0.0, VolumeUnit.Litre, _volumeConverter);
            var zeroGal = new Quantity<VolumeUnit>(0.0, VolumeUnit.Gallon, _volumeConverter);
        ...
        public void testTransitiveEquality_GallonToLitreToML()
        {
            var gallon = new Quantity<VolumeUnit>(1.0, VolumeUnit.Gallon, _volumeConverter);
            var litre = new Quantity<VolumeUnit>(3.78541, VolumeUnit.Litre, _volumeConverter);
            var ml = new Quantity<VolumeUnit>(3785.41, VolumeUnit.MilliLiter, _volumeConverter);
        ...
        {
            var largeLitre = new Quantity<VolumeUnit>(1000000.0, VolumeUnit.Litre, _volumeConverter);
        ...
        public void testSmallVolume_MillLitreToGallon()
        {
            ...
            var oneMl = new Quantity<VolumeUnit>(1.0, VolumeUnit.MilliLiter, _volumeConverter);
        ...
        {
            var q1 = new Quantity<VolumeUnit>(10.0, VolumeUnit.Gallon, _volumeConverter);
            var zeroMl = new Quantity<VolumeUnit>(0.0, VolumeUnit.MilliLiter, _volumeConverter);
        ...
        {
            var original = new Quantity<VolumeUnit>(10.0, VolumeUnit.Litre, _volumeConverter);
